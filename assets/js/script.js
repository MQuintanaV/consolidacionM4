...
function pintarGastosEliminar(){
    ...
    for(let j=0; j<limiteEliminar; j++){
        ...
        let unIcono = document.createElement('p');
        ...
        unIcono.innerHTML = '<img src="assets/img/trash-can-solid.svg" alt="">';
        unIcono.setAttribute('onclick', `eliminarElemento(${j})`);
        ...
        unParrafoAccionNuevo.appendChild(unIcono);
...
function pintarGastos(){
    ...
    let unParrafoValorNuevo = document.createElement('p');
    let unParrafoAccionNuevo = document.createElement('p');
    let unIcono = document.createElement('div');
    ...
    for(let i=0; i<arrNombresGastos.length; i++){
        ...
        unIcono.innerHTML = '<img src="assets/img/trash-can-solid.svg" alt="">';
        unIcono.setAttribute('onclick', `eliminarElemento(${i})`);
